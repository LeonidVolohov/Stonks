...
class StocksFragmentTest {
    ...
    fun testingTest() {
        ...
        val scenario = launchInContainer(StocksFragment::class.java, args, R.style.Theme_Stonks)
        scenario.onFragment { fragment ->
            fragment.updateStockData(false)
            fragment.toggleGroupPeriod.check(R.id.togglebutton_one_year_selector)
        }
    }
